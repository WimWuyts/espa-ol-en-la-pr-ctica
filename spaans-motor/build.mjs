...
const tplName = { classify:"classificeren", match:"koppelen", cloze:"invullen", order:"volgorde", point:"aanwijzen", tap:"aanwijzen", memory:"memoria", sim:"produceren", speak:"spreken" };
