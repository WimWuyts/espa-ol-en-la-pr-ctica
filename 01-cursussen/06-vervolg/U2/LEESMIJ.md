...
|---|---|---|
| **C6plus_U2.pdf** | Print-cursus (38 p, 46 oefeningen) | Afdrukken/projecteren. Niet bewerkbaar. |
| **C6plus_U2_BEWERKBAAR.html** | Bewerkbare laag van de PDF | Chrome/Edge → **«Bewerken»** · **«Opslaan als PDF»** · **«Bewaar»**. |
| **C6plus_U2_web.html** | Digitale hub (standalone, offline) | 7 tabbladen: Vocabulario (flip cards) · Gramática (hay/estar · gerundio · lo/la, interactief) · Lectura · Juegos (12 spellen) · Hablar (opname) · Cultura (klikbare kaart, Colombia ★) · Extra. 100+ zelfcorrigerende oefeningen met «↻ otra serie». |
