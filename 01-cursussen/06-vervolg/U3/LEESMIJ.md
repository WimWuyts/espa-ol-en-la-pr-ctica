...
|---|---|---|
| **C6plus_U3.pdf** | Print-cursus (44 p, 35 genummerde + 5 ★/tarea + 5 V = 45 oefeningen, plus §7 Lectura en §8 Escucha) | Afdrukken/projecteren. Niet bewerkbaar. |
| **C6plus_U3_BEWERKBAAR.html** | Bewerkbare laag van de PDF | Chrome/Edge → **«Bewerken»** · **«Opslaan als PDF»** · **«Bewaar»**. |
| **C6plus_U3_web.html** | Digitale hub (standalone, offline) | 8 tabbladen: Vocabulario (flip cards) · Gramática (ir a · le/les · creo que, interactief) · Lectura · **Escuchar 🎧** · Juegos (13 spellen) · Hablar (opname) · Cultura (klikbare kaart, México ★ música) · Extra. 164 inline-oefeningen + 13 games met «↻ otra serie». |
