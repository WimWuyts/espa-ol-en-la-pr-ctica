# C4 · U1 «Presentaciones» — Cocktail-receta (gebouwde golden sample)

> Ingevuld ná de build (de 47 U1-IDs staan in `C4_coverage.md`). Parada 1 · «El despegue».

## De smaak van deze unit
Eerste contact met het Spaans: groeten, jezelf voorstellen, afscheid nemen. Dominante vaardigheid =
...
## Onderdeel → reservoir-ingrediënten (eerste gebruik = vet)

| Onderdeel | Ingrediënten (reservoir-ID) | Waarom hier |
|---|---|---|
| **Escucha** (YouTube + meelees-transcript) | **DS-043** (compositie A: video links, meelezen rechts) · **LAY-031** (avatar/kleur per spreker) · **DS-037** (speech bubbles) · **SK-054** (globaal→detail) · **SK-060** (luisteren als start) · **SK-062** (luisteren & kiezen: ¿qué oyes?) · **PPT-032** (pauzeer/voorspel — in het deck) | chunks auditief binnen; markeren = noticing |
...
| **Navigatie/huisstijl** | **LAY-011** (hero) · **LAY-007** (mini-inhoud = hub-tabs) · **LAY-049** (QR naar hub) | vaste chrome |

## Hub-games (motor)
Nog uit te breiden bij de motor-integratie; gepland ≥6 types: `match` (chunk↔situatie) · `classify`
(saludo/respuesta/despedida/cortesía) · `order` (diálogo) · `memory` (ES↔NL) · `tap`/`point` (¿qué oyes?)
· `cloze`-light (me ___ / ___ de). *(In de huidige hub zit de Práctica als native zelfcorrigerend blok.)*

## PowerPoint (docente + alumno) — gebruikte ideeën
**PPT-006** (vaste knoppen/menu) · **PPT-011** (klik-onthullen) · **PPT-012** (meerkeuze-feedback) ·
**PPT-022** (beeld-woord-audio) · **PPT-032** (pauzeer/voorspel) · **PPT-037** (shadowing). Dia's:
TÍTULO · MENÚ · ESCUCHA · KIT · GRAMÁTICA(2) · PRÁCTICA · HABLAR · MÚSICA · TAREA · REPASO · TEACHER.

## Woordenschat — curatie
~40 chunks in 6 taalhandelingen: **saludar · responder · presentarse · preguntar · cortesía · despedirse.**
...
- [x] ≥1 luisterdialoog (Escucha + begripstaak) · ≥1 spreek/interactie-taak (Tarea)
- [x] Receptief→productief met afbouw · antwoordruimte in print
- [x] Grammatica enkel functioneel (VG/GT ~-items)
