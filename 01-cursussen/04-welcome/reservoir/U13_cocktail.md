...
|---|---|---|
| **enlace (en_el_hotel)** | vraagintonatie | luister-en-herhaal + klap de klemtoon + dictee + hardop lezen met ✓/✗ van je buur |

## Matrix B · chunk-recycling

De chunks van deze unit staan in `escena_data.ESCENAS[13]["chunks"]` en komen
...
Nieuw in deze unit: **F26**. Zie `funciones_data.py` en
`C4_funciones_matrix.md`.

## Gramática

**usted** — visueel aangeboden (voorbeelden → patroon → valstrik), daarna een
klassieke cloze én een substitutieketen. Zie `kit_data.GRAMATICA[13]`.
