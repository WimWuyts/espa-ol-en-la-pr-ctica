...
> **Doel:** garanderen dat tegen U8 de meeste van de 453 reservoir-items érgens zijn gebruikt (= variatie).
> **Bron:** `reservoir.json`. **U0–U4-kolommen = automatische heuristische detectie** (op itemnaam-trefwoorden in de unit-tekst) — een *startschatting*, niet exact. Vanaf U5 vult elke `U<N>_cocktail.md` de exacte gebruikte IDs in en wordt dit grootboek precies.
> Legende: ✓ = (waarschijnlijk) gebruikt · leeg = beschikbaar om te plukken.

## Nog beschikbaar per domein (de plukvijver voor U5–U8)

| Domein | Totaal | Gebruikt (schatting) | **Nog beschikbaar** |
|---|--:|--:|--:|
| designcomponent | 50 | 3 | **47** |
| grammatica-patroon | 35 | 19 | **16** |
| grammaticatool | 25 | 6 | **19** |
| layout | 50 | 10 | **40** |
| powerpoint | 50 | 15 | **35** |
| vaardigheid | 120 | 63 | **57** |
| werkvorm | 100 | 45 | **55** |
| woordenschat-patroon | 23 | 7 | **16** |
| **TOTAAL** | **453** | **168** | **285** |
