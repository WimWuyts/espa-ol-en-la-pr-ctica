...
def s03_escucha():
    ...
    text(s, Inches(8.45), Inches(1.75), Inches(4.1), Inches(3.1),
         [[("Chunks para llevar 🎒", {"size": 14, "bold": True, "color": GD, "font": DISPLAY})],
          [("Hola · ¿Cómo estás? · Bien", {"size": 13, "color": INK})],
          [("¿Cómo te llamas? · Me llamo…", {"size": 13, "color": INK})],
          [("Yo soy… · Encantado/a · Igualmente", {"size": 13, "color": INK})],
          [("Muchas gracias · De nada", {"size": 13, "color": INK})],
          [("¡Bienvenida! · Hasta luego · Adiós", {"size": 13, "color": INK})]])
