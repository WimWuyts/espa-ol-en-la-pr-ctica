...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 1 (parada <b>Madrid · Lucía</b>): flashcards, gramática visual e interactiva, <b>__NGAMES__ juegos</b> con muchas series y <b>más de 100 ejercicios</b> con autocorrección. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie.</span></p></div>
  </div>
...
__TYPESLOTS__
  ...
  <section class="panel" data-p="lectura">
    ...
    <h2 class="sec">Lectura completa · el perfil de Álex</h2>
    ...
    <div class="card ex" id="lec_u1"></div>
  </section>


  <section class="panel" data-p="escuchar">
    <h2 class="sec">Escuchar · el primer día en el instituto 🎧</h2>
    ...
    <div class="card ex" id="esc_u1"></div>
  </section>
  ...
  <section class="panel" data-p="retos">
    ...
    <p class="lead">Drie opdrachten met <b>één harde regel</b> die de makkelijke weg afsnijdt: het juiste lidwoord telt pas als je ook de <b>regel</b> kiest, de plaza van 1985 beschrijf je in het <b>presente</b>, en je partner stel je voor aan iemand die <b>geen Nederlands</b> kent. <span class="gloss">De zeven andere retos van deze unit staan in het boek en in de PowerPoint.</span></p>
    <div id="retos_u1"></div>
      __COACH__
  </section>
