#!/usr/bin/env python3
# C4 · Unidad 7 — HTML-HUB (tabbladen, srcdoc-iframes). C4-rood. Zelfde pijplijn als U1–U6.
import base64, os
...
TABS=[
 ("escucha","🎬 Escucha","C4_U7_escucha.html","Mira la escena y lee al mismo tiempo: los chunks te entran por el oído. <span class="stn">bekijk en lees mee</span>"),
 ("comprension","📖 Lee y escucha","C4_U7_comprension.html","Una lectura y una escucha cortas: entiende el español que ya sabes. <span class="stn">korte lees- en luisteroefening</span>"),
 ("mapa","🗺️ Mapa","C4_U7_mapa.html","La Ruta — pulsa un país del mundo hispano y lee su ficha. <span class="stn">klik op een land</span>"),
 ("funciones","🗣️ Funciones","C4_U7_funciones.html","Lo que puedes HACER con el español: tu repertorio crece cada unidad. <span class="stn">wat je met het Spaans kunt doen</span>"),
 ("kit","🧰 Kit","C4_U7_kgt.html","Pronunciación (c/qu, esdrújula), la lengua por situación, gramática (ser + profesión · ser/estar) y tarea. <span class="stn">uitspraak, taal per situatie, grammatica en taak</span>"),
 ("practica","✍️ Práctica","C4_U7_practica.html","Practica y corrígete: reconocer → elegir → decirlo tú. <span class="stn">zelfcorrigerend oefenen</span>"),
 ...
 ("coach","📝 Entrega","C4_U7_coach.html",
  "Escribe tu tarea final y hazla revisar antes de entregarla. <span class="stn">schrijf en laat nakijken</span>"),
 ("musica","🎧 Música","C4_U7_musica.html","Cultura (el trabajo hispano) + banda sonora — aprende español con música. <span class="stn">leer Spaans via muziek</span>"),
]
...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>C4 · Unidad 7 · Las profesiones — Hub</title><style>{CSS}</style></head><body>
<div class="hero">
  <span class="ruta">🗺️ La Ruta · C4 «El despegue» · Parada 7</span>
  <h1>Unidad 7 · Las profesiones</h1>
  <p>Pregunta y di a qué se <b>dedica</b> alguien: ¿a qué te dedicas? — soy profesora, trabajo en una academia. Y adivina como Josefina: ¿puede ser actriz? Todo lo que oyes aquí lo puedes usar enseguida. <span class="stn">vraag en zeg wat iemand doet</span> <i>Survival in Spanish.</i></p>
</div>
...
open(f"{CMP}/C4_U7_hub.html","w",encoding="utf-8").write(HTML)
print("C4_U7_hub.html geschreven:",len(HTML),"bytes")
