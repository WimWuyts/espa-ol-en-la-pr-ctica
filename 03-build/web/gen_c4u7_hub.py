...
TABS=[
 ("escucha","🎬 Escucha","C4_U7_escucha.html","Bekijk de scène en lees mee — de chunks komen uit je oren."),
 ("comprension","📖 Lee y escucha","C4_U7_comprension.html","Een korte lees- en luisteroefening — begrijp het Spaans dat je al kent."),
 ("mapa","🗺️ Mapa","C4_U7_mapa.html","La Ruta — klik op een land van de Spaanstalige wereld en lees zijn fiche."),
...
<div class="hero">
  ...
  <p>Vraag en zeg wat iemand <b>doet</b>: ¿a qué te dedicas? — soy profesora, trabajo en una academia. En gis zoals Josefina: ¿puede ser actriz? Alles wat je hier hoort, kun je meteen gebruiken. <i>Survival in Spanish.</i></p>
</div>
