...
<div class="page sec" style="break-before:page">
  ...
  <!-- de twee laatste reglas naast elkaar: gestapeld liep de sectie 25 mm over
       haar blad en viel er een handvol regels op een verder leeg blad 6. Naast
       elkaar past ze precies, en vier identieke kaders onder elkaar is
       bovendien net wat de huisstijl niet wil (CLAUDE.md §13). -->
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 5mm;align-items:start">
