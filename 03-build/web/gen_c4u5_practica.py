...
<div class="top"><h1>Unidad 5 · Objetos cotidianos — Práctica</h1><p>Practica la lengua útil de la escena: de <b>reconocer</b> → <b>elegir</b> → <b>decirlo y escribirlo tú</b>. Todo se corrige solo; pulsa 🔊 para oírlo. <span class="stn">van herkennen naar zelf zeggen</span></p></div>
<main>
...
(function(){var el=document.getElementById('g_escucha');if(!TTS){el.innerHTML='<h3>¿Qué oyes? 🎧</h3><p class="desc">Spraak werkt in Chrome/Edge.</p>';return;}
 ...
 el.innerHTML='<h3>¿Qué oyes? 🎧</h3><p class="desc">Pulsa ▶, escucha y elige el objeto que oyes. <span class="stn">luister en kies het voorwerp</span></p>'+sb('sbE')+'<div style="margin:6px 0"><button class="spk-btn" id="eP">▶ Speel af</button></div><div class="chips" id="eO"></div><div class="fb" id="eF"></div>';
...
(function(){var el=document.getElementById('g_clasifica');
 ...
 el.innerHTML='<h3>Clasifica 🎯</h3><p class="desc">¿Es de la clase, de casa, o es una función (para qué sirve)? <span class="stn">klas, huis of functie?</span></p>'+sb('sbC')+'<div id="cw" style="font-size:24px;font-family:var(--disp);text-align:center;margin:8px 0"></div><div class="chips" id="cc" style="justify-content:center"></div><div class="fb" id="cf"></div>';
...
(function(){var el=document.getElementById('g_match');
 ...
 el.innerHTML='<h3>Relaciona · ¿para qué sirve? 🧩</h3><p class="desc">Pulsa a la izquierda un objeto y a la derecha para qué sirve. <span class="stn">verbind voorwerp en functie</span></p>'+sb('sbM')+'<div style="display:grid;grid-template-columns:1fr 1fr;gap:14px"><div class="chips" style="flex-direction:column" id="mL"></div><div class="chips" style="flex-direction:column" id="mR"></div></div><div class="fb" id="mf"></div>';
...
(function(){var el=document.getElementById('g_completa');
 ...
 el.innerHTML='<h3>Completa el diálogo 💬</h3><p class="desc">Completa (piensa en es/son · un/una · sirve · hay). <span class="stn">vul aan</span></p>'
...
(function(){var el=document.getElementById('g_ordena');
 ...
 el.querySelector('#oC').onclick=function(){fb(el.querySelector('#oF'),cur.join('|')===sol.join('|'),cur.join('|')===sol.join('|')?'¡Perfecto!':'Todavía no — empieza por «¿Qué es esto?».');};
...
(function(){var el=document.getElementById('g_identifica');
 el.innerHTML='<h3>Identifica un objeto ✍️🗣️</h3><p class="desc">Elige un objeto, di qué es y para qué sirve. No hay respuesta «correcta»: es tu objeto. <span class="stn">het is jouw voorwerp</span></p>'
