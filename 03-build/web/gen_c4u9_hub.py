#!/usr/bin/env python3
# C4 · Unidad 9 — HTML-HUB (tabbladen, srcdoc-iframes). C4-rood. Zelfde pijplijn als U1–U8.
# NB: de video van U9 komt (zoals U8) uit Google Drive (/preview-embed) i.p.v. YouTube.
import base64, os
...
TABS=[
 ("escucha","🎬 Escucha","C4_U9_escucha.html","Mira la escena y lee al mismo tiempo: los chunks te entran por el oído. <span class="stn">bekijk en lees mee</span>"),
 ("comprension","📖 Lee y escucha","C4_U9_comprension.html","Una lectura y una escucha cortas: entiende el español que ya sabes. <span class="stn">korte lees- en luisteroefening</span>"),
 ("mapa","🗺️ Mapa","C4_U9_mapa.html","La Ruta — pulsa un país y di qué vas a visitar allí («voy a visitar…»). <span class="stn">klik en zeg wat je gaat bezoeken</span>"),
 ("funciones","🗣️ Funciones","C4_U9_funciones.html","Lo que puedes HACER con el español: tu repertorio crece cada unidad. <span class="stn">wat je met het Spaans kunt doen</span>"),
 ("kit","🧰 Kit","C4_U9_kgt.html","Pronunciación (diptongos ie/ue), el constructor de frases, la lengua por situación, gramática (ir a · tener que · tener + sustantivo) y tarea. <span class="stn">uitspraak, zinbouwer, taal per situatie, grammatica en taak</span>"),
 ("practica","✍️ Práctica","C4_U9_practica.html","Practica y corrígete: reconocer → elegir → decirlo tú. <span class="stn">zelfcorrigerend oefenen</span>"),
 ...
 ("coach","📝 Entrega","C4_U9_coach.html",
  "Escribe tu tarea final y hazla revisar antes de entregarla. <span class="stn">schrijf en laat nakijken</span>"),
 ("musica","🎧 Música","C4_U9_musica.html","Cultura (el finde hispano) + banda sonora — aprende español con música. <span class="stn">leer Spaans via muziek</span>"),
]
...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>C4 · Unidad 9 · Planes y obligaciones — Hub</title><style>{CSS}</style></head><body>
<div class="hero">
  <span class="ruta">🗺️ La Ruta · C4 «El despegue» · Parada 9</span>
  <h1>Unidad 9 · Planes y obligaciones</h1>
  <p>Haz <b>planes</b> y di lo que <b>tienes que</b> hacer: voy a preparar café · tengo que trabajar. Y rechaza con educación: no puedo, tengo que… Todo lo que oyes aquí lo puedes usar enseguida. <span class="stn">maak plannen, zeg wat je moet doen, wijs beleefd af</span> <i>Survival in Spanish.</i></p>
</div>
...
open(f"{CMP}/C4_U9_hub.html","w",encoding="utf-8").write(HTML)
print("C4_U9_hub.html geschreven:",len(HTML),"bytes")
