...
TABS=[
 ("escucha","🎬 Escucha","C4_U9_escucha.html","Bekijk de scène en lees mee — de chunks komen uit je oren."),
 ("comprension","📖 Lee y escucha","C4_U9_comprension.html","Een korte lees- en luisteroefening — begrijp het Spaans dat je al kent."),
 ("mapa","🗺️ Mapa","C4_U9_mapa.html","La Ruta — klik op een land en zeg wat je er gaat bezoeken («voy a visitar…»)."),
...
<div class="hero">
  ...
  <p>Maak <b>plannen</b> en zeg wat je <b>moet</b> doen: voy a preparar café · tengo que trabajar. En wijs beleefd af: no puedo, tengo que… Alles wat je hier hoort, kun je meteen gebruiken. <i>Survival in Spanish.</i></p>
</div>
