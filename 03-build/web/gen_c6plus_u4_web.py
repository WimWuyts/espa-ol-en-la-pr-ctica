...
<title>Más español en la práctica · C6+ U4 De viaje</title>
...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 4 (<b>de viaje</b>): flashcards, gramática visual e interactiva y <b>__NGAMES__ juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie. Thema's: transporte · perfecto compuesto · participios · por/para.</span></p></div>
  </div>
...
__TYPESLOTS__
  ...
  <section class="panel" data-p="lectura">
    ...
    <h2 class="sec">Lectura completa · Una postal desde Valparaíso</h2>
    <p class="lead">Een echte postkaart met dagboek, met de volledige leesroute: <b>voorspellen → globaal → scannen → juist/fout met bewijs → betekenis uit de context → zelf schrijven</b>. <span class="gloss">Dezelfde tekst staat in je cursus, met schrijfruimte.</span></p>
    <div class="card ex" id="lec_c6p_u4"></div>
  </section>

  <section class="panel" data-p="escuchar">
    <h2 class="sec">Escuchar · En la recepción del hostal 🎧</h2>
    <p class="lead">Nina komt aan met een reservering die niet klopt. Eén fragment, zes stappen: eerst <b>weten waar je bent</b>, dan <b>globaal</b> luisteren, dan de <b>details</b>, dan <b>juist/fout met bewijs</b>. Het <b>transcript</b> gaat pas open als je klaar bent — anders lees je mee in plaats van te luisteren. <span class="gloss">Zolang er nog geen opname is, leest de computerstem het fragment voor.</span></p>
    <div class="card ex" id="esc_c6p_u4"></div>
  </section>
  ...
  <section class="panel" data-p="retos">
    ...
    <p class="lead">Drie retos met <b>één harde regel</b>: je vertelt een reis die je <b>nooit gemaakt hebt</b> alsof je er was (alles in het perfecto, en de klas zoekt het gat), je neemt drie stationsomroepen op in de <b>usted</b>-vorm met de vaste formules, en je kiest wat een Vlaamse reiziger in vier échte situaties beter wél zegt. <span class="gloss">De zeven andere retos van deze unit staan in het boek en in de PowerPoint.</span></p>
    <div id="retos_c6p_u4"></div>
      __COACH__
  </section>
  ...
  <div class="foot">Más español en la práctica · edición única · Unidad 4 «De viaje» — página digital. Uitbreiding op de PDF · huisstijl morado · print ↔ PowerPoint ↔ web.</div>
</main>
...
JS += hub_type_gram.js('C6+', 4)
JS += hub_bloques.retos_js('retos_c6p_u4', 'C6+', 4)
JS += (hub_bloques.escucha_js("esc_c6p_u4", escucha_data.C6P_U4)
       + hub_bloques.lectura_js("lec_c6p_u4", lectura_data.C6P_U4))
HTML = HTML.replace("__GRAMSLOTS__", hub_type_gram.slots('C6+', 4))
HTML = HTML.replace("__NGAMES__", str(len(GAMES)))
HTML = HTML.replace("__BRONNEN__", extra_bronnen.html('C6+', 4))
