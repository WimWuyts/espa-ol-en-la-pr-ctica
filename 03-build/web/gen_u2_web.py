...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 2 (parada <b>Sevilla</b>, la ciudad de Lucía): flashcards, el árbol de Rosalía, gramática visual e interactiva, <b>+100 ejercicios</b> con zelfcorrectie y <b>__NGAMES__ juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie.</span></p></div>
  </div>
...
__TYPESLOTS__
  ...
  <section class="panel" data-p="lectura">
    ...
    <h2 class="sec">Lectura completa · el correo de Lucía</h2>
    <p class="lead">Een echte mail met de volledige leesroute: <b>voorspellen → globaal → scannen → juist/fout met bewijs → betekenis uit de context → zelf schrijven</b>. <span class="gloss">Dezelfde tekst staat in je cursus, met schrijfruimte.</span></p>
    <div class="card ex" id="lec_u2"></div>
  </section>

  <section class="panel" data-p="escuchar">
    <h2 class="sec">Escuchar · ¿Quién es quién? 🎧</h2>
    <p class="lead">De klas speelt een raadspel met tien foto's. Eén fragment, zes stappen: eerst <b>weten waar je bent</b>, dan <b>globaal</b> luisteren, dan de <b>details</b>, dan <b>juist/fout met bewijs</b>. Het <b>transcript</b> gaat pas open als je klaar bent — anders lees je mee in plaats van te luisteren. <span class="gloss">Zolang er nog geen opname is, leest de computerstem het fragment voor.</span></p>
    <div class="card ex" id="esc_u2"></div>
  </section>
  ...
  <section class="panel" data-p="retos">
    ...
    <p class="lead">Drie opdrachten met <b>één harde regel</b>: je hoort een beschrijving één keer en kiest dán pas, je beantwoordt de <b>drie</b> vragen van abuelo Curro, en je vat drie buren samen zonder er één weg te laten. <span class="gloss">De zeven andere retos van deze unit staan in het boek en in de PowerPoint.</span></p>
    <div id="retos_u2"></div>
      __COACH__
  </section>
...
JS += hub_type_gram.js('C5', 2)
JS += hub_bloques.retos_js('retos_u2', 'C5', 2)
JS += (hub_bloques.escucha_js("esc_u2", escucha_data.C5_U2)
       + hub_bloques.lectura_js("lec_u2", lectura_data.C5_U2))
HTML = HTML.replace("__GRAMSLOTS__", hub_type_gram.slots('C5', 2))
HTML = HTML.replace("__NGAMES__", str(len(GAMES)))
HTML = HTML.replace("__BRONNEN__", extra_bronnen.html('C5', 2))
