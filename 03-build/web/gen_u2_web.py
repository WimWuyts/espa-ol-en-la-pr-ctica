...
<main>
  ...
  <section class="panel" data-p="cultura">
    ...
    <div class="card"><h3 style="font-family:var(--disp);color:var(--gd);margin:0 0 6px;display:flex;align-items:center;gap:8px"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><path d="M4 16s.5-1 2-1 2.5 2 4 2 2.5-2 4-2 2.5 2 4 2 2-1 2-1"/><path d="M2 21h20"/><path d="M7 8v3"/><path d="M12 8v3"/><path d="M17 8v3"/><path d="M7 4h.01"/><path d="M12 4h.01"/><path d="M17 4h.01"/></svg>La quinceañera y Frida Kahlo 🎉</h3>
      <p><b>ES:</b> En América Latina, cuando una chica cumple <b>15 años</b>, se celebra la <b>quinceañera</b>: una gran fiesta familiar con vestido y baile. Y la pintora mexicana <b>Frida Kahlo</b> pintó su <b>árbol genealógico</b> en «Mis abuelos, mis padres y yo». <span class="gloss">Het grote 15-jaarsfeest; Frida schilderde haar eigen stamboom.</span></p></div>
...
(function(){
 const INFO={
  ESP:{fl:'🇪🇸',n:'España',cap:'Madrid',f:'Onze parada 2: Sevilla, en Andalucía — la ciudad de Lucía.',nl:'Parada 2 · Sevilla (Lucía).',star:1},
