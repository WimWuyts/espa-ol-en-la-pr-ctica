...
<div class="tcard">
  ...
  <div class="carne">
    <div class="carne-h">DICCIONARIO DE LA CLASE · Academia «Welcome to Spanish»</div>
...
SUENA=('<div class="suena">'
 ...
 '<p class="sh">Tussen klinkers is de <b>r</b> <b>zacht</b> — één tikje van de tong: «pe-ro», «ca-ra». Klik 🔊 en spreek na.</p>'
 ...
 '<p class="sh">Klik de woorden met de <b>sterke</b> r-klank (rr of begin-r; groen = juist). Klik 🔊 om te horen.</p>'
 ...
 '<p class="sh">Het accent (<i>la tilde</i>) staat op de <b>sterkste</b> lettergreep. Klik 🔊 en herhaal.</p>'
...
<main>
 ...
 {TAREA}
 <div class="foot">C4 · «Welcome to Spanish» · Unidad 5 · Objetos cotidianos</div>
</main>
<script>
