#!/usr/bin/env python3
# C4 · Unidad 8 — HTML-HUB (tabbladen, srcdoc-iframes). C4-rood. Zelfde pijplijn als U1–U7.
# NB: de video van U8 komt uit Google Drive (/preview-embed) i.p.v. YouTube.
import base64, os
...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>C4 · Unidad 8 · La hora y los días — Hub</title><style>{CSS}</style></head><body>
<div class="hero">
...
open(f"{CMP}/C4_U8_hub.html","w",encoding="utf-8").write(HTML)
print("C4_U8_hub.html geschreven:",len(HTML),"bytes")
