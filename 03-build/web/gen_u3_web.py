...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 3 (parada <b>Barcelona</b>): flashcards, gramática visual e interactiva, <b>__NGAMES__ juegos</b> y <b>+100 ejercicios</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie.</span></p></div>
  </div>
...
__TYPESLOTS__
  ...
  <section class="panel" data-p="lectura">
    ...
    <h2 class="sec">Lectura completa · el chat de Marc y Júlia</h2>
    <p class="lead">Een echte chat met de volledige leesroute: <b>voorspellen → globaal → scannen → juist/fout met bewijs → betekenis uit de context → zelf schrijven</b>. <span class="gloss">Dezelfde tekst staat in je cursus, met schrijfruimte.</span></p>
    <div class="card ex" id="lec_u3"></div>
  </section>

  <section class="panel" data-p="escuchar">
    <h2 class="sec">Escuchar · Mi sábado en Barcelona 🎧</h2>
    <p class="lead">Pau stuurt Sam een paar spraakberichten over zijn zaterdag. Eén fragment, zes stappen: eerst <b>weten waar je bent</b>, dan <b>globaal</b> luisteren, dan de <b>details</b>, dan <b>juist/fout met bewijs</b>. Het <b>transcript</b> gaat pas open als je klaar bent — anders lees je mee in plaats van te luisteren. <span class="gloss">Zolang er nog geen opname is, leest de computerstem het fragment voor.</span></p>
    <div class="card ex" id="esc_u3"></div>
  </section>
  ...
  <section class="panel" data-p="retos">
    ...
    <p class="lead">Drie opdrachten met <b>één harde regel</b>: je kiest het werkwoord op wat je hóórt (het uur beslist), je vertelt je dag in <b>exact</b> zestig seconden, en je ondertitelt in maximaal acht woorden zonder betekenis te verliezen. <span class="gloss">De zeven andere retos van deze unit staan in het boek en in de PowerPoint.</span></p>
    <div id="retos_u3"></div>
      __COACH__
  </section>
...
JS += hub_type_gram.js('C5', 3)
JS += hub_bloques.retos_js('retos_u3', 'C5', 3)
JS += (hub_bloques.escucha_js("esc_u3", escucha_data.C5_U3)
       + hub_bloques.lectura_js("lec_u3", lectura_data.C5_U3))
HTML = HTML.replace("__GRAMSLOTS__", hub_type_gram.slots('C5', 3))
HTML = HTML.replace("__NGAMES__", str(len(GAMES)))
HTML = HTML.replace("__BRONNEN__", extra_bronnen.html('C5', 3))
