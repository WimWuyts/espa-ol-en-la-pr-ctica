...
<div class="tcard">
  ...
  <div class="carne">
    <div class="carne-h">MI ÁRBOL DE FAMILIA · Academia «Welcome to Spanish»</div>
...
SUENA=('<div class="suena">'
 ...
 '<p class="sh">De <b>ll</b> klinkt in de meeste landen als de NL «j» in «ja»: «calle» ≈ «ca-je». Klik 🔊 en spreek na.</p>'
 ...
 '<p class="sh">Klik de woorden met de <b>ll/y</b>-klank /ʝ/ (groen = juist). Klik 🔊 om te horen.</p>'
 ...
 '<p class="sh">De <b>meeste</b> Spaanse woorden zijn <i>llana</i>: klemtoon op de <b>voorlaatste</b> lettergreep. Klik 🔊 en herhaal.</p>'
