#!/usr/bin/env python3
# C4 · Unidad 6 — HTML-HUB (tabbladen, srcdoc-iframes). C4-rood. Zelfde pijplijn als U1–U5.
import base64, os
...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>C4 · Unidad 6 · La casa — Hub</title><style>{CSS}</style></head><body>
<div class="hero">
...
open(f"{CMP}/C4_U6_hub.html","w",encoding="utf-8").write(HTML)
print("C4_U6_hub.html geschreven:",len(HTML),"bytes")
