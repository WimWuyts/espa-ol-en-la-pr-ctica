...
TABS=[
 ("escucha","🎬 Escucha","C4_U2_escucha.html","Mira la escena y lee al mismo tiempo: los chunks te entran por el oído. <span class='stn'>bekijk en lees mee</span>"),
 ("comprension","📖 Lee y escucha","C4_U2_comprension.html","Una lectura y una escucha cortas: entiende el español que ya sabes. <span class='stn'>korte lees- en luisteroefening</span>"),
 ("mapa","🗺️ Mapa","C4_U2_mapa.html","La Ruta — pulsa un país del mundo hispano y lee su ficha. <span class='stn'>klik op een land</span>"),
 ("funciones","🗣️ Funciones","C4_U2_funciones.html","Lo que puedes HACER con el español: tu repertorio crece cada unidad. <span class='stn'>wat je met het Spaans kunt doen</span>"),
 ("kit","🧰 Kit","C4_U2_kgt.html","Pronunciación (la jota, la h muda), la lengua por situación, gramática y tarea. <span class='stn'>uitspraak, taal per situatie, grammatica en taak</span>"),
 ("practica","✍️ Práctica","C4_U2_practica.html","Practica y corrígete: reconocer → elegir → decirlo tú. <span class='stn'>zelfcorrigerend oefenen</span>"),
 ("rol","🎭 Ensaya","C4_U2_rol.html",
  "Representa la escena: el compañero te corrige y funciona sin internet. <span class='stn'>speel de scène, ook offline</span>"),
 ("coach","📝 Entrega","C4_U2_coach.html",
  "Escribe tu tarea final y hazla revisar antes de entregarla. <span class='stn'>schrijf en laat nakijken</span>"),
 ("musica","🎧 Música","C4_U2_musica.html","Banda sonora — aprende español con música que ya conocéis. <span class='stn'>muziek die jullie kennen</span>"),
]
...
<div class="hero">
  ...
  <p>Saludar según el <b>momento del día</b> y decir <b>cómo te sientes</b> (estar + estado). Todo lo que oyes aquí lo puedes usar enseguida. <span class='stn'>groeten naar het moment van de dag, en zeggen hoe je je voelt</span> <i>Survival in Spanish.</i></p>
</div>
