...
SUENA=('<div class="suena">'
 ...
 '<p class="sh">Fíjate en dónde cae el acento en los números: así dices bien las horas. Pulsa 🔊 y repite. <span class="gloss">klemtoon in getallen helpt bij de uren</span></p>'
