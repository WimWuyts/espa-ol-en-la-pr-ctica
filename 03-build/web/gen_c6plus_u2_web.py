...
<title>Español en la práctica · C6+ U2 Aquí vivo</title>
...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 2 (<b>aquí vivo</b>): flashcards, gramática visual e interactiva y <b>12 juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie. Thema's: la casa · hay/estar · gerundio · lo/la.</span></p></div>
  </div>
...
__TYPESLOTS__
  ...
  <section class="panel" data-p="extra">
    ...
    <div class="card"><p>🎬 <b>profedeele</b> (YouTube — hay/estar + preposiciones / estar + gerundio) — <span class="gloss">link volgt.</span></p>
    <p>🧩 <b>arche-ele</b> (Genially — los pronombres lo/la / la casa y el barrio) — <span class="gloss">link volgt.</span></p>
    <p>📄 In het boek (PDF) verwijzen de QR-codes naar déze pagina, op het juiste ankerpunt.</p></div>
  </section>

  <div class="foot">Español en la práctica · C6+ · Unidad 2 «Aquí vivo» — página digital. Uitbreiding op de PDF · huisstijl morado · print ↔ PowerPoint ↔ web.</div>
</main>
