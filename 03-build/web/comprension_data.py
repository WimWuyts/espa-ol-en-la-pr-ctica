...
LECTURA = {
 ...
 11: {
  "tipo":"un mensaje de vacaciones · ¿qué tiempo hace?",
  "contexto_nl":"Een berichtje van Marta uit Tenerife aan haar vriendin.",
  "texto":[["","¡Hola, Lucía! Estoy en Tenerife con mis primos."],
           ["","Aquí siempre hace buen tiempo: hace sol y 24 grados."],
           ["","Por la mañana voy a la playa y por la tarde hago yoga."],
           ["","Me gusta mucho el mar, pero no me gustan los hoteles grandes."],
           ["","En Madrid, en cambio, ahora hace mucho calor. ¡Demasiado!"],
           ["","¿Y tú? ¿Qué tiempo hace en Bélgica? ¿Qué te gusta hacer en verano? Marta"]],
  "global":[{"q":"¿Qué es este texto?","opts":["Un mensaje de vacaciones","Una carta del hotel","Un parte del tiempo"],"a":0},
            {"q":"¿Qué tiempo hace en Tenerife?","opts":["Hace frío y viento","Hace sol y buen tiempo","Llueve mucho"],"a":1}],
  "detalle":[{"q":"En Tenerife hace buen tiempo.","vf":True},
             {"q":"A Marta le gustan los hoteles grandes.","vf":False},
             {"q":"Marta hace yoga por la tarde.","vf":True},
             {"q":"En Madrid hace frío.","vf":False}],
  "transfer":"¿Y tú? ¿Qué tiempo hace hoy? ¿Qué te gusta hacer cuando hace calor?",
  "glosario":[["hace buen tiempo","het is mooi weer"],["hace sol","het is zonnig"],
              ["me gusta el mar","ik hou van de zee"],["no me gustan…","ik hou niet van… (meervoud)"],
              ["en cambio","daarentegen"],["demasiado","te veel / te"]],
 },
}
...
AUDIO = {
 ...
 11: {
  "tipo":"gustos y frecuencia · ¿qué te gusta hacer?",
  "guion":[["Nuria","¿Qué te gusta hacer los fines de semana?"],
           ["Hugo","Me gusta el cine. Voy mucho, casi todas las semanas."],
           ["Nuria","A mí también me gusta el cine. ¿Y los deportes?"],
           ["Hugo","No me gustan mucho, pero hago yoga dos veces por semana."],
           ["Nuria","Yo voy al gimnasio tres veces por semana. ¿Y cuando hace mal tiempo?"],
           ["Hugo","Cuando hace frío, casi nunca salgo. Me gusta estar en casa."]],
  "tarea_nl":"Luister: wat vindt Hugo leuk — en hoe vaak doet hij het?",
  "preguntas":[{"q":"¿Qué le gusta a Hugo?","opts":["Los deportes","El cine","Los hoteles"],"a":1},
               {"q":"¿Cuántas veces por semana hace yoga Hugo?","opts":["Una","Dos","Tres"],"a":1},
               {"q":"¿Qué hace Hugo cuando hace frío?","opts":["Va al gimnasio","Casi nunca sale","Va al cine"],"a":1}],
  "glosario":[["me gusta el cine","ik hou van film"],["no me gustan…","ik hou niet van… (meervoud)"],
              ["a mí también","ik ook"],["dos veces por semana","twee keer per week"],
              ["casi nunca","bijna nooit"],["hace mal tiempo","het is slecht weer"]],
  "rallentado":["me gusta el cine","tres veces por semana","casi nunca salgo"],
 },
}
