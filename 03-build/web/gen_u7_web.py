...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 7 (parada <b>Colombia · Cartagena</b>): flashcards, gramática visual e interactiva y <b>20 juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie.</span></p></div>
  </div>
  ...
  <section class="panel" data-p="extra">
    ...
    <div class="card"><p>🎬 <b>profedeele</b> (YouTube — hay/estar · preposiciones de lugar · el imperativo) — <span class="gloss">link volgt.</span></p>
    <p>🧩 <b>arche-ele</b> (Genially — la casa · el barrio · las direcciones) — <span class="gloss">link volgt.</span></p>
...
(function(){
 const INFO={
  COL:{fl:'🇨🇴',n:'Colombia',cap:'Bogotá',f:'Onze parada 7: Cartagena de Indias. Casas de colores, plazas, balcones con flores y el mar Caribe. Gastvrouw = Valen (costeña).',nl:'Parada 7 · Cartagena (Valen).',star:1},
  MEX:{fl:'🇲🇽',n:'México',cap:'Ciudad de México',f:'Paradas anteriores (U5–U6): CDMX y los mercados. Tacos, guacamole.',nl:'Paradas U5–U6 (Diego).',star:1},
  ...
  PER:{fl:'🇵🇪',n:'Perú',cap:'Lima',f:'Próxima parada: Cusco y Machu Picchu (U8). El ceviche es típico.',nl:'Parada van Nina (U8).',star:1},
