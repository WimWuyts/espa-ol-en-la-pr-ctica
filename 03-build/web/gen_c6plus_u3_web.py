...
<title>Español en la práctica · C6+ U3 Conectados</title>
...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 3 (<b>conectados</b>): flashcards, gramática visual e interactiva y <b>13 juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie. Thema's: media/redes · ir a + infinitivo · le/les · creo que.</span></p></div>
  </div>
  ...
  <section class="panel" data-p="extra">
    ...
    <div class="card"><p>🎬 <b>profedeele</b> (YouTube — ir a + infinitivo / los pronombres le/les) — <span class="gloss">link volgt.</span></p>
    <p>🧩 <b>arche-ele</b> (Genially — el futuro próximo / dar tu opinión) — <span class="gloss">link volgt.</span></p>
    <p>📄 In het boek (PDF) verwijzen de QR-codes naar déze pagina, op het juiste ankerpunt.</p></div>
  </section>

  <div class="foot">Español en la práctica · C6+ · Unidad 3 «Conectados» — página digital. Uitbreiding op de PDF · huisstijl morado · print ↔ PowerPoint ↔ web.</div>
</main>
