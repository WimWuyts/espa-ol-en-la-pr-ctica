...
MOTOR = [
 ...
 ['③ Producir con apoyo', [
   ...
   ['senala', 'señala', 'point'],
   ['tilde-reflexivo', '¿dónde va la tilde?', 'tap']]],
 ['④ Hablar · grábate 🎙️', [
   ['repite-dia', 'escucha y repite: mi día', 'speak'],
   ['mensaje-dia', 'mensaje de voz: mi día a día', 'speak'],
   ['mi-dia', 'cuenta tu día', 'sim'],
   ['carrusel-rutina', 'carrusel · mi rutina', 'speak']]],
...
__TYPESLOTS__
  ...
  <section class="panel" data-p="retos">
    ...
    <p class="lead">Drie retos met <b>één harde regel</b>: twaalf scènes waarin alleen het <b>detail</b> beslist tussen <i>es</i> en <i>está</i>, een podcast van twee minuten waarin <b>niets</b> mag gebeuren (zes verschillende conectoren maken het boeiend), en vier agenda's waarin je het enige mogelijke moment zoekt — of bewijst dat het niet bestaat. <span class="gloss">De zeven andere retos van deze unit staan in het boek en in de PowerPoint.</span></p>
...
JS += hub_bloques.retos_js('retos_c6p_u1', 'C6+', 1)
