...
ESCENAS = {
 11: {
  ...
  "escenas": [
   ("Escena 1 · En el bar",
    "Julio praat met de barman over de vakantie. Een klant luistert mee.",
    [("Julio", "Ella se va de vacaciones a la playa, a Canarias. Siempre hace buen tiempo en Canarias. Viaja con unos amigos; con un amigo, un inglés.",
     ...
     ("Camarero", "Ya. ¿Y tú te quedas en Madrid?",
      "Juist. En jij, blijf jij in Madrid?"),
     ("Julio", "Yo voy todos los años al Caribe.",
      "Ik ga elk jaar naar de Caraïben."),
     ("Camarero", "¿Y la familia?",
      "En de familie?"),
     ("Julio", "Es que me gusta hacer submarinismo.",
      "Het is gewoon dat ik graag ga duiken."),
     ("Camarero", "Ya. A ella también le gusta hacer submarinismo.",
      "Juist. Zij duikt ook graag."),
     ("Julio", "¿Por qué no lo intentas?",
      "Waarom probeer je het niet?"),
     ("Camarero", "Bueno, es que en Ávila es difícil, ¿sabes? Yo voy mucho al cine.",
