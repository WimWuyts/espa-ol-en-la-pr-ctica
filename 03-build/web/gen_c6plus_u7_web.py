...
<title>Español en la práctica · C6+ U7 ¡Opina y cuídate!</title>
...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 7 (<b>¡opina y cuídate!</b>): flashcards, gramática visual e interactiva y <b>12 juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie. Thema's: salud · medio ambiente · imperativo · opinar.</span></p></div>
  </div>
  ...
  <section class="panel" data-p="extra">
    ...
    <div class="card"><p>🎬 <b>profedeele</b> (YouTube — el imperativo / opinar) — <span class="gloss">link volgt.</span></p>
    <p>🧩 <b>arche-ele</b> (Genially — imperativo / conectores) — <span class="gloss">link volgt.</span></p>
    <p>📄 In het boek (PDF) verwijzen de QR-codes naar déze pagina, op het juiste ankerpunt.</p></div>
  </section>

  <div class="foot">Español en la práctica · C6+ · Unidad 7 «¡Opina y cuídate!» — página digital. Uitbreiding op de PDF · huisstijl morado · print ↔ PowerPoint ↔ web.</div>
</main>
