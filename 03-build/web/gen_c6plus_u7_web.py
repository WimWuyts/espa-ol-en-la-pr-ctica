...
__TYPESLOTS__
  ...
  <section class="panel" data-p="retos">
    ...
    <p class="lead">Drie retos met <b>één harde regel</b>: een radiospot van <b>dertig seconden</b> waarin het advies pas in de laatste tien komt, een kringspel waarin je <b>eerst gelijk moet geven</b> en pas daarna mag nuanceren, en vier Vlaamse campagnes die je bruikbaar maakt voor Cartagena — de vorm verandert, het idee blijft. <span class="gloss">De zeven andere retos van deze unit staan in het boek en in de PowerPoint.</span></p>
    <div id="retos_c6p_u7"></div>
      __COACH__
  </section>
...
JS += hub_bloques.retos_js('retos_c6p_u7', 'C6+', 7)
