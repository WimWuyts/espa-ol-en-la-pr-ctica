...
<title>Español en la práctica · C6+ U6 Cuando era pequeño</title>
...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 6 (<b>cuando era pequeño</b>): flashcards, gramática visual e interactiva y <b>12 juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie. Thema's: infancia · imperfecto · contraste · comparativos.</span></p></div>
  </div>
  ...
  <section class="panel" data-p="extra">
    ...
    <div class="card"><p>🎬 <b>profedeele</b> (YouTube — el imperfecto / contraste indef-imperf) — <span class="gloss">link volgt.</span></p>
    <p>🧩 <b>arche-ele</b> (Genially — imperfecto / comparativos) — <span class="gloss">link volgt.</span></p>
    <p>📄 In het boek (PDF) verwijzen de QR-codes naar déze pagina, op het juiste ankerpunt.</p></div>
  </section>

  <div class="foot">Español en la práctica · C6+ · Unidad 6 «Cuando era pequeño» — página digital. Uitbreiding op de PDF · huisstijl morado · print ↔ PowerPoint ↔ web.</div>
</main>
