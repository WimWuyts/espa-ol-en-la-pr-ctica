...
<div class="tcard">
  ...
  <div class="carne">
    <div class="carne-h">¿QUIÉN SOY? · Academia «Welcome to Spanish»</div>
...
SUENA=('<div class="suena">'
 ...
 '<p class="sh">Vóór <b>a, o, u</b> klinkt de <b>c</b> als /k/: «casa», «cocina», «médico». Klik 🔊 en spreek na.</p>'
 ...
 '<p class="sh">Klik de woorden met de klemtoon op de <b>derde lettergreep van achter</b> (<i>esdrújula</i> — MÉ-di-co; groen = juist). Klik 🔊 om te horen.</p>'
 ...
 '<p class="sh"><i>Esdrújulas</i> hebben <b>altijd</b> een accent: MÉ-di-co, MÚ-si-ca. Klik 🔊 en herhaal met een dikke klemtoon.</p>'
