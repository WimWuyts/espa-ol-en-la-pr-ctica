#!/usr/bin/env python3
# C4 · Unidad 11 — HTML-HUB (tabbladen, srcdoc-iframes). C4-rood. Zelfde pijplijn als U1–U10.
# NB: de video van U11 komt (zoals U8–U10) uit Google Drive (/preview-embed) i.p.v. YouTube.
import base64, os
...
TABS=[
 ("escucha","🎬 Escucha","C4_U11_escucha.html","Bekijk de scène en lees mee — de chunks komen uit je oren."),
 ("comprension","📖 Lee y escucha","C4_U11_comprension.html","Een korte lees- en luisteroefening — begrijp het Spaans dat je al kent."),
 ("mapa","🗺️ Mapa","C4_U11_mapa.html","La Ruta — klik op een land en ontdek zijn klimaat (in het zuiden zijn de seizoenen omgekeerd!)."),
 ("funciones","🗣️ Funciones","C4_U11_funciones.html","Wat je met het Spaans kunt DOEN — je repertoire groeit elke unit."),
 ("kit","🧰 Kit","C4_U11_kgt.html","Uitspraak (de scherpe s), het gustómetro, de taal per situatie, gramática (hace + weer · me gusta ↔ me gustan · frecuencia) & tarea."),
 ("practica","✍️ Práctica","C4_U11_practica.html","Oefen zelfcorrigerend: herkennen → kiezen → zelf zeggen."),
 ("musica","🎧 Música","C4_U11_musica.html","Cultura (el clima del mundo hispano) + banda sonora — «Me gustas tú» is één lange me-gusta-oefening."),
]
...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>C4 · Unidad 11 · El tiempo y los gustos — Hub</title><style>{CSS}</style></head><body>
<div class="hero">
  <span class="ruta">🗺️ La Ruta · C4 «El despegue» · Parada 11</span>
  <h1>Unidad 11 · El tiempo y los gustos</h1>
  <p>Praat over het <b>weer</b> en over wat je <b>graag doet</b>: <b>hace frío</b> · <b>hace demasiado calor</b> · <b>me gusta el cine</b> · <b>me gustan los deportes</b> — en zeg <b>hoe vaak</b>: <b>siempre</b>, <b>a veces</b>, <b>casi nunca</b>. <i>Survival in Spanish.</i></p>
</div>
...
open(f"{CMP}/C4_U11_hub.html","w",encoding="utf-8").write(HTML)
print("C4_U11_hub.html geschreven:",len(HTML),"bytes")
