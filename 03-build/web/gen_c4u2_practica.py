...
<div class="top"><h1>Unidad 2 · Saludos — Práctica</h1><p>Practica la lengua útil de la escena: de <b>reconocer</b> → <b>elegir</b> → <b>decirlo y escribirlo tú</b>. Todo se corrige solo; pulsa 🔊 para oírlo. <span class="stn">van herkennen naar zelf zeggen</span></p></div>
<main>
...
(function(){var el=document.getElementById('g_presentate');
 el.innerHTML='<h3>Saluda y di cómo estás ✍️🗣️</h3><p class="desc">Elige un momento del día, di cómo te sientes y dilo en voz alta. No hay respuesta «correcta»: es tu saludo. <span class="stn">het is jouw begroeting</span></p>'
