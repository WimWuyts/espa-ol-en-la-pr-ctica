...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 6 (parada <b>México · los mercados</b>): flashcards, gramática visual e interactiva y <b>20 juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie.</span></p></div>
  </div>
  ...
  <section class="panel" data-p="extra">
    ...
    <div class="card"><p>🎬 <b>profedeele</b> (YouTube — pronombres OD / la ropa) — <span class="gloss">link volgt.</span></p>
    <p>🧩 <b>arche-ele</b> (Genially — la ropa / de compras) — <span class="gloss">link volgt.</span></p>
...
(function(){
 const INFO={
  MEX:{fl:'🇲🇽',n:'México',cap:'Ciudad de México',f:'Onze parada 6: los mercados y tianguis de México. Ropa, colores, rebajas y regateo. Meeste Spaanstaligen ter wereld (~130 mln).',nl:'Parada 6 · los mercados (Diego).',star:1},
