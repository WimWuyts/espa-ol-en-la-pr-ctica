...
(function(){var el=document.getElementById('g_escucha');if(!TTS){el.innerHTML='<h3>¿Qué oyes? 🎧</h3><p class="desc">El audio funciona en Chrome/Edge. <span class="nl">Spraak werkt in Chrome/Edge.</span></p>';return;}
 ...
 el.innerHTML='<h3>¿Qué oyes? 🎧</h3><p class="desc">Pulsa ▶, escucha y elige lo que oyes. <span class="nl">Klik ▶, luister en kies wat je hoort.</span></p>'+sb('sbE')+'<div style="margin:6px 0"><button class="spk-btn" id="eP">▶ Escuchar</button></div><div class="chips" id="eO"></div><div class="fb" id="eF"></div>';
