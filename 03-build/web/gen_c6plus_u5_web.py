...
<title>Más español en la práctica · C6+ U5 Érase una vez</title>
...
<main>
  <div class="hero">
    ...
    <p>La página digital de la Unidad 5 (<b>érase una vez</b>): flashcards, gramática visual e interactiva y <b>__NGAMES__ juegos</b> con muchas series. <span style="opacity:.85">Uitbreiding van het boek (PDF): elke QR brengt je hier om te oefenen met zelfcorrectie. Thema's: biografía · pretérito indefinido · fuertes · se lo/se la.</span></p></div>
  </div>
...
__TYPESLOTS__
  ...
  <section class="panel" data-p="lectura">
    ...
    <h2 class="sec">Lectura completa · La leyenda de la yerba mate</h2>
    <p class="lead">Een echte leyenda met de volledige leesroute: <b>voorspellen → globaal → scannen → juist/fout met bewijs → betekenis uit de context → zelf schrijven</b>. <span class="gloss">Dezelfde tekst staat in je cursus, met schrijfruimte.</span></p>
    <div class="card ex" id="lec_c6p_u5"></div>
  </section>

  <section class="panel" data-p="escuchar">
    <h2 class="sec">Escuchar · Los que llegaron en barco 🎧</h2>
    <p class="lead">Een rondleiding in het immigratiemuseum van Buenos Aires. Eén fragment, zes stappen: eerst <b>weten waar je bent</b>, dan <b>globaal</b> luisteren, dan de <b>details</b>, dan <b>juist/fout met bewijs</b>. Het <b>transcript</b> gaat pas open als je klaar bent — anders lees je mee in plaats van te luisteren. <span class="gloss">Zolang er nog geen opname is, leest de computerstem het fragment voor.</span></p>
    <div class="card ex" id="esc_c6p_u5"></div>
  </section>
  ...
  <section class="panel" data-p="retos">
    ...
    <p class="lead">Drie retos met <b>één harde regel</b>: vijf voorwerpen gaan de klas rond en je reconstrueert met <b>se lo, se la, se los, se las</b> wie wat aan wie gaf, je brengt een gedenkdag als nieuwsflits van <b>dertig seconden</b> (de vier w's in de eerste zin), en je vertelt een ingewikkelde biografie na voor een kind van acht — <b>vereenvoudigen zonder te liegen</b>. <span class="gloss">De zeven andere retos van deze unit staan in het boek en in de PowerPoint.</span></p>
    <div id="retos_c6p_u5"></div>
      __COACH__
  </section>
  ...
  <div class="foot">Más español en la práctica · edición única · Unidad 5 «Érase una vez» — página digital. Uitbreiding op de PDF · huisstijl morado · print ↔ PowerPoint ↔ web.</div>
</main>
...
JS += hub_bloques.retos_js('retos_c6p_u5', 'C6+', 5)
JS += (hub_bloques.escucha_js("esc_c6p_u5", escucha_data.C6P_U5)
       + hub_bloques.lectura_js("lec_c6p_u5", lectura_data.C6P_U5))
HTML = HTML.replace("__GRAMSLOTS__", hub_type_gram.slots('C6+', 5))
HTML = HTML.replace("__NGAMES__", str(len(GAMES)))
HTML = HTML.replace("__BRONNEN__", extra_bronnen.html('C6+', 5))
