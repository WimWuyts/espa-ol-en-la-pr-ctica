...
SUENA=('<div class="suena">'
 ...
 '<p class="sh">La mayoría de las palabras son <i>llanas</i> (acento en la <b>penúltima</b>): ca·SA. Pulsa 🔊 y repite. <span class="gloss">llana = klemtoon voorlaatste</span></p>'
