...
def qr(data):
    ...
    return svg
HUB_URL="https://hablacon-ene.local/C4/U4"
...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>C4 · Unidad 4 · La familia</title><style>{CSS}</style></head><body>
{EDITBAR}
